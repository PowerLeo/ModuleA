...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/xiaoli_dev/ModuleA'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'xiaoli_dev' => 'ali@coinsea.pro' }
  s.source           = { :git => 'https://github.com/xiaoli_dev/ModuleA.git', :tag => s.version.to_s }
